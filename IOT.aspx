<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IOT.aspx.cs" Inherits="Workshop" %>
...
<head runat="server">
	...
	<meta name="description" content="IOT Workshop: Wouldn't it be absolutely ingenious if you had a smart air conditioner that could cool down your room to the to the perfect temperature when you
                        return home on a hot summer day? JUEE Students Forum welcomes you to the world of IOT with a 2 day workshop , "An Introduction to the Development of Embedded Systems and IOT using Arduino Uno." />
...
.box:hover::before {
  left: 100%;
    ...
    <script type = "text/javascript">
        function Alert1() {
            alert('Event is over now !!!');
        }

    </script>
     <script type = "text/javascript">
         function Alert2() {
             alert('You are successfully registered for IOT Workshop');
         }
    ...
    <div class="container" >
		...
		<nav id="ml-menu" class="menu">
			...
			<div class="menu__wrap">
				<ul runat="server" data-menu="main" class="menu__level" tabindex="-1" role="menu" aria-label="All">
					...
					<li runat="server" class="menu__item" role="menuitem"><a runat="server" class="menu__link" data-submenu="submenu-1" aria-owns="submenu-1" href="#">Events</a></li>
					<li runat="server" class="menu__item" role="menuitem"><a runat="server" class="menu__link" data-submenu="submenu-2" aria-owns="submenu-2" href="#">Workshops</a></li>
					<li runat="server" class="menu__item" role="menuitem"><a runat="server" class="menu__link" data-submenu="submenu-3" aria-owns="submenu-3" href="/Sponsors.aspx">Sponsors</a></li>
					<li runat="server" class="menu__item" role="menuitem"><a runat="server" class="menu__link" data-submenu="submenu-4" aria-owns="submenu-4" href="#">Committee</a></li>
				...
				<ul  data-menu="submenu-2" id="submenu-2" class="menu__level" tabindex="-1" role="menu" aria-label="Workshops">
					<li runat="server" class="menu__item" role="menuitem"><a id="workshop" class="menu__link" href="/IOT.aspx" runat="server">IOT</a></li>				
				</ul>
				<!-- Submenu 2-1 -->
        ...
        <img src="Images/Workshop/image1.jpg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="Images/Workshop/img12.jpg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">3 / 3</div>
        <img src="Images/Workshop/img13.jpg" style="width:100%; height:350px;"/>
        </div>
        </div>
        <br/>
        ...
        <div>
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h3 class="section-heading" style="margin-top:0;font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif;">IOT Workshop</h3>
                    <hr class="light"/ style="border-color: white; border-width: 3px;max-width: 50px;"/>
                    <p class="text-faded" style="color: rgba(255, 255, 255, 0.7); font-size:16px;line-height:1.2;margin-bottom:10px;">Wouldn't it be absolutely ingenious if you had a smart air conditioner that could cool down your room to the to the perfect temperature when you
                        return home on a hot summer day? JUEE Students Forum welcomes you to the world of IOT with a 2 day workshop , "An Introduction to the Development of Embedded Systems and IOT using Arduino Uno.
                    </p>
...
Copyright ©<script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved.
    ...
    <script type="text/javascript">
        ...
        {
            window.open("/Data/IOT.pdf","_blank");
        }
    </script>
	<script>
	    (function () {
