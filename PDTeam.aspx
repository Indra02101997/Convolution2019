<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PDTeam.aspx.cs" Inherits="PDTeam" %>
...
<head id="Head1" runat="server">
	...
	<title>Panel Discussion Team</title>
    ...
    <div class="container" >
		...
		<div class="content" style="background-color:#2a2b30;">
            <form id="form1" runat="server">
                <p class="section-heading" style="margin-top:auto; text-align:center; text-decoration:solid; font-size:20px; font-weight:bold; font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif; z-index:auto;"><u>Panel Discussion Team</u></p>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Abhirup.jpeg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption1" runat="server"> Abhirup Saha</figcaption>
                     <figcaption class="caption" id="Figcaption3" runat="server"> 8013561614 </figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Aratrika.jpeg" style=" border-radius:50%" />
                        <figcaption id="Figcaption2" class="caption" runat="server">Aratrika Sengupta</figcaption>
                        <figcaption class="caption" id="Figcaption4" runat="server"> 8337032448</figcaption>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Samadrita.jpeg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption5" runat="server">Samadrita Chowdhuri </figcaption>
                     <figcaption class="caption" id="Figcaption6" runat="server"> 6290588266 </figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Titas.jpeg" style=" border-radius:50%" />
                        <figcaption id="Figcaption7" class="caption" runat="server">Titas Biswas </figcaption>
                        <figcaption class="caption" id="Figcaption8" runat="server"> 7098597338</figcaption>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Soham.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption9" runat="server">Soham Chowdhury</figcaption>
                     <figcaption class="caption" id="Figcaption10" runat="server">9007931725</figcaption>
                   </div>
