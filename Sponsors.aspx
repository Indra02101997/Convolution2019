    ...
    <div class="container" >
		...
		<div class="content" style="background-color:#2a2b30;">
            <form id="form1" runat="server">
                <p class="section-heading" style="margin-top:auto; text-align:center; text-decoration:solid; font-size:20px; font-weight:bold; font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif; z-index:auto;"><u>Our Past Sponsors</u></p>
                <div style="text-align:center; display:flexbox;" class="datalist">
                    <asp:DataList ID="Datalist1" runat="server" HorizontalAlign="Center" RepeatDirection="Horizontal"  RepeatColumns="4" DataKeyField="Name"  CellPadding="0" CellSpacing="30">
                <ItemTemplate>
                <asp:HyperLink ID="hyperlink1" runat="server" Target="_blank" NavigateUrl='<%# Eval("Link") %>'><asp:Image ID="imagebutton1" runat="server" ImageUrl='<%#Eval("Image") %>' Width="145px" Height="145px" CssClass="img" />  </asp:HyperLink>        
            </ItemTemplate>
        </asp:DataList>
            </div>
                <div class="row">
                    <div class="column">
                    <a href="https://www.cesc.co.in" target="_blank"><img class="resize" src="SponsorImages/Cesc.PNG" style=" border-radius:25%" /></a>
                   </div>
                    <div class="column" style="">
                     <a href="http://www.chloridepowersystems.co.in" target="_blank"><img class="resize1" src="SponsorImages/Chloride.PNG" style="border-radius:25%" /></a>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <a href="http://www.ieeecss.org/" target="_blank"><img class="resize" src="SponsorImages/CSS.PNG" style=" border-radius:25%" /></a>
                   </div>
                    <div class="column" style="">
                     <a href="http://www.dvc.gov.in/dvcwebsite_new1/" target="_blank"><img class="resize1" src="SponsorImages/DVC.PNG" style="border-radius:25%" /></a>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <a href="http://www.haldiaenergy.co.in/" target="_blank"><img class="resize" src="SponsorImages/Hel.PNG" style=" border-radius:25%" /></a>
                   </div>
                    <div class="column" style="">
                     <a href="http://www.ieee.org/" target="_blank"><img class="resize1" src="SponsorImages/IEEE.PNG" style="border-radius:25%" /></a>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <a href="https://ieeedeis.org/" target="_blank"><img class="resize" src="SponsorImages/IEEEDeis.PNG" style=" border-radius:25%" /></a>
                   </div>
                    <div class="column" style="">
                     <a href="https://www.ieee-pes.org/" target="_blank"><img class="resize1" src="SponsorImages/IEEEPes.PNG" style="border-radius:25%" /></a>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <a href="http://www.theiet.org/" target="_blank"><img class="resize" src="SponsorImages/IET.PNG" style=" border-radius:25%" /></a>
                   </div>
                    <div class="column" style="">
                     <a href="http://ieee-ims.org/" target="_blank"><img class="resize1" src="SponsorImages/IM.PNG" style="border-radius:25%" /></a>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <a href="http://www.indusree.com/" target="_blank"><img class="resize" src="SponsorImages/Indusree.PNG" style=" border-radius:25%" /></a>
                   </div>
                    <div class="column" style="">
                     <a href="http://www.megatherm.com/" target="_blank"><img class="resize1" src="SponsorImages/megatherm.PNG" style="border-radius:25%" /></a>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <a href="http://www.ntplindia.com/" target="_blank"><img class="resize" src="SponsorImages/NTPL.PNG" style=" border-radius:25%" /></a>
                   </div>
                    <div class="column" style="">
                     <a href="https://www.systematixinfotech.com/" target="_blank"><img class="resize1" src="SponsorImages/Systematix.PNG" style="border-radius:25%" /></a>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <a href="http://www.techno.co.in/" target="_blank"><img class="resize" src="SponsorImages/TechnoElectric.PNG" style=" border-radius:25%" /></a>
                   </div>
                    <div class="column" style="">
                     <a href="https://www.facebook.com/WowMomos/" target="_blank"><img class="resize1" src="SponsorImages/WowMomo.PNG" style="border-radius:25%" /></a>
                     </div>                    
                </div>
