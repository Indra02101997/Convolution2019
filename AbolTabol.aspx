<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AbolTabol.aspx.cs" Inherits="AbolTabol" %>
...
<head id="Head1" runat="server">
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
        <meta name="description" content="Abol Tabol: This year Convolution introduces its
...
be a hilarious exercise on how one can induce scientific fervor into hypotheses that have zero
truth in them and were perhaps just sketched out on a whim!" />
	<title>Abol Tabol</title>
...
.box:hover::before {
  left: 100%;
    ...
    <script type = "text/javascript">
        function Alert1() {
            alert('You are already registered for AbolTabol');
        }

    </script>
     <script type = "text/javascript">
         function Alert2() {
             alert('You are successfully registered for AbolTabol');
         }
...
<body>
    <div class="container" >
        ...
        <img src="Images/Aboltabol/img1.jpeg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="Images/Aboltabol/img2.jpeg" style="width:100%; height:350px;"/>
        </div>

              <div class="mySlides fade">
        <div class="numbertext">3 / 3</div>
        <img src="Images/Aboltabol/img3.jpeg" style="width:100%; height:350px;"/>
        </div>
        ...
        <div>
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h3 class="section-heading" style="margin-top:0;font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif;">Abol Tabol</h3>
                    ...
                    <p class="text-faded" style="color: rgba(255, 255, 255, 0.7); font-size:16px;line-height:1.2;margin-bottom:10px;">
                        This year Convolution introduces its
very own version of bringing together absolutely fictitious scientific theories justified by well
thought-out and convincingly researched reasoning before a panel of judges. This event shall
be a hilarious exercise on how one can induce scientific fervor into hypotheses that have zero
truth in them and were perhaps just sketched out on a whim!
...
Copyright ©<script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved.
    ...
    <script type="text/javascript">
        function button1_click() {
            window.open("/Data/AbolTabol.pdf", "_blank");
        }
    </script>
	<script>
	    (function () {
