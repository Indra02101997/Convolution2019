<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TechHuntTeam.aspx.cs" Inherits="TechHuntTeam" %>
    ...
    <div class="container" >
		...
		<div class="content" style="background-color:#2a2b30;">
            <form id="form1" runat="server">
                <p class="section-heading" style="margin-top:auto; text-align:center; text-decoration:solid; font-size:20px; font-weight:bold; font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif; z-index:auto;"><u>Tech-Hunt Team</u></p>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Sugata1.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption1" runat="server"> Sugata Sen(Event Lead)</figcaption>
                     <figcaption class="caption" id="Figcaption5" runat="server"> 7980084089</figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/RounakS.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption2" class="caption" runat="server"> Rounak Sikdar</figcaption>
                        <figcaption class="caption" id="Figcaption6" runat="server"> 9046714034</figcaption>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Rudrashis.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption3" runat="server"> Rudrashis Chakraborty</figcaption>
                     <figcaption class="caption" id="Figcaption4" runat="server"> 8981457758</figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Mousam.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption7" class="caption" runat="server">Mousam Dutta</figcaption>
                        <figcaption class="caption" id="Figcaption8" runat="server"> 7003764818</figcaption>
                     </div>  
                 </div>
                  <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/partha.jpeg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption9" runat="server">Partha Sarathi Mondal</figcaption>
                     <figcaption class="caption" id="Figcaption10" runat="server">9874987129</figcaption>
                   </div>                   
                 </div>
