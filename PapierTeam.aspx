<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PapierTeam.aspx.cs" Inherits="PapierTeam" %>
    ...
    <div class="container" >
		...
		<div class="content" style="background-color:#2a2b30;">
            <form id="form1" runat="server">
                <p class="section-heading" style="margin-top:auto; text-align:center; text-decoration:solid; font-size:20px; font-weight:bold; font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif; z-index:auto;"><u>Papier Team</u></p>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Debarpan.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption1" runat="server">Debarpan Bhattacharya(Event Lead)</figcaption>
                     <figcaption class="caption" id="Figcaption3" runat="server"> 8420058801 </figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Arko.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption2" class="caption" runat="server">Arka Prabha Saha</figcaption>
                        <figcaption class="caption" id="Figcaption4" runat="server"> 8777034591</figcaption>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Sagnik.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption5" runat="server">Sagnik Bhattacharya</figcaption>
                     <figcaption class="caption" id="Figcaption6" runat="server">8583063063</figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Sukanya.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption7" class="caption" runat="server">Sukanya Das</figcaption>
                        <figcaption class="caption" id="Figcaption8" runat="server">8348604462</figcaption>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Suvadeep1.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption9" runat="server">Suvadeep Maiti </figcaption>
                     <figcaption class="caption" id="Figcaption10" runat="server">8240586094</figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Moja.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption11" class="caption" runat="server">Mojaffar Islam</figcaption>
                        <figcaption class="caption" id="Figcaption12" runat="server">9153539095</figcaption>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Kshitij.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption13" runat="server">Kshitij Kumar </figcaption>
                     <figcaption class="caption" id="Figcaption14" runat="server">7903094583</figcaption>
                   </div>                  
                </div>
