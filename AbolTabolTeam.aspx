<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AbolTabolTeam.aspx.cs" Inherits="AbolTabolTeam" %>
    ...
    <div class="container" >
		...
		<div class="content" style="background-color:#2a2b30;">
            <form id="form1" runat="server">
                <p class="section-heading" style="margin-top:auto; text-align:center; text-decoration:solid; font-size:20px; font-weight:bold; font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif; z-index:auto;"><u>Abol Tabol Team</u></p>
               <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Sukanya.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption1" runat="server"> Sukanya Das(Event Lead)</figcaption>
                     <figcaption class="caption" id="Figcaption3" runat="server"> 8348604462 </figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Sagnik.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption2" class="caption" runat="server"> Sagnik Bhattacharya</figcaption>
                        <figcaption class="caption" id="Figcaption4" runat="server"> 8583063063</figcaption>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Bhaskar1.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption5" runat="server"> Bhaskar Dutta</figcaption>
                     <figcaption class="caption" id="Figcaption6" runat="server"> 7044629680</figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/RounakA.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption7" class="caption" runat="server">Rounak Adhikary</figcaption>
                        <figcaption class="caption" id="Figcaption8" runat="server">8584032846</figcaption>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Ashique.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption9" runat="server">Ashique Billa Molla </figcaption>
                     <figcaption class="caption" id="Figcaption10" runat="server">7585837421</figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Hardik.jpeg" style=" border-radius:50%" />
                        <figcaption id="Figcaption11" class="caption" runat="server">Hardik Dalmia</figcaption>
                        <figcaption class="caption" id="Figcaption12" runat="server">9874426802</figcaption>
                     </div>                    
                </div>
