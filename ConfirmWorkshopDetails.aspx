<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfirmWorkshopDetails.aspx.cs" Inherits="ConfirmWorkshopDetails" %>
...
.box:hover::before {
  left: 100%;
    ...
    <script type = "text/javascript">
        function Alert1() {
            alert('You are already registered for IOT Workshop');
        }
...
.question input[type="text"]:valid ~ label {
  font-style: italic;
  -moz-transform: translate(5px, -35px) scale(1);
  -ms-transform: translate(5px, -35px) scale(1);
  -webkit-transform: translate(5px, -35px) scale(1);
...
<body>
		...
		<nav id="ml-menu" class="menu">
			...
			<div class="menu__wrap">
				<ul id="Ul1" runat="server" data-menu="main" class="menu__level" tabindex="-1" role="menu" aria-label="All">
					...
					<li id="Li4" runat="server" class="menu__item" role="menuitem"><a id="A4" runat="server" class="menu__link" data-submenu="submenu-3" aria-owns="submenu-3" href="#">Sponsors</a></li>
  ...
  <div class="question">
    <input type="text" id="textbox1" runat="server" required="required" readonly="readonly"/>
    <label style="margin-top:-12vh; font-style:italic;position:absolute">Email Id</label>
  </div>
  <div class="question">
  ...
  <div class="question">
    <input type="text" id="textbox4" runat="server" required="required"/>
    <label>Phone</label>
  </div>
            <form id="form1" runat="server">
                <button id="button1" class="box" runat="server" onclick="button1_click()">Details</button>
                <button id="button2" class="btn-liquid" runat="server" onserverclick="button2_click" ><span class="inner">Confirm</span></button>
                <br />
                <br />
                <br />
                <p class="section-heading" style="margin-top:auto; text-align:center; font-size:18px; font-weight:bold; font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif; z-index:auto;">For Queries contact:</p>
                <br />
                <br />
...
Copyright ©<script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved.
    ...
    <script type="text/javascript">
        function button1_click() {
            window.open("/Data/power supply system.pdf", "_blank");
        }
    </script>
	<script>
	    (function () {
