<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CoreCommittee.aspx.cs" Inherits="CoreCommittee" %>
    ...
    <div class="container" >
		...
		<div class="content" style="background-color:#2a2b30;">
            <form id="form1" runat="server">
                <p class="section-heading" style="z-index:100000; text-align:center; text-decoration:solid; font-size:17px; font-weight:bold; font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif; z-index:auto;"><u>Core Committee Members</u></p>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Taritra.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption1" runat="server"> Taritra Saha(Secretary)</figcaption>
                      <figcaption class="caption" id="Figcaption10" runat="server" >8017961897</figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Abhirup.jpeg" style=" border-radius:50%" />
                        <figcaption class="caption" runat="server"> Abhirup Saha(Treasurer)</figcaption>
                        <figcaption class="caption" id="Figcaption11" runat="server">8013561614</figcaption>
                     </div>                    
                </div>
                    <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Anwesa.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption2" runat="server"> Anwesa Bhattacharya(Joint Secretary)</figcaption>
                      <figcaption class="caption" id="Figcaption12" runat="server">8777287718</figcaption>
                    </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Aritra.jpg" style=" border-radius:50%" />
                        <figcaption class="caption" id="Figcaption3" runat="server"> Aritra Ghosh(Joint Treasurer)</figcaption>
                        <figcaption class="caption" id="Figcaption13" runat="server">8961394434</figcaption>
                    </div>
                    </div>
                    <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Samrajni.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption4" runat="server">Samrajni Sarkar(Event Manager)</figcaption>
                     <figcaption class="caption" id="Figcaption14" runat="server">8637328092</figcaption>
                    </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Aratrika.jpeg" style=" border-radius:50%" />
                        <figcaption class="caption" id="Figcaption5" runat="server"> Aratrika Sengupta(Sponsor Lead)</figcaption>
                        <figcaption class="caption" id="Figcaption15" runat="server">8337032448</figcaption>
                    </div>
                    </div>
                    <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/PPC.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption6" runat="server"> Pranabendra Prasad Chandra(Publicity Lead)</figcaption>
                      <figcaption class="caption" id="Figcaption16" runat="server">9874987129</figcaption>
                    </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Bhaskar1.jpg" style=" border-radius:50%" />
                        <figcaption class="caption" id="Figcaption7" runat="server">Bhaskar Dutta(Design Lead)</figcaption>
                        <figcaption class="caption" id="Figcaption17" runat="server">8961394434</figcaption>
                    </div>
                    </div>
         
                   <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Soham.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption8" runat="server" style="">Soham Choudhury(Logistics Lead)</figcaption>
                     <figcaption class="caption" id="Figcaption18" runat="server">9007931725</figcaption>
                    </div>
                       <div class="column" style="">
                     <img class="resize1" src="Team/IP.jpg" style=" border-radius:50%" />
                        <figcaption class="caption" id="Figcaption9" runat="server">Indraneel Pal(Website Management)</figcaption>
                        <figcaption class="caption" id="Figcaption19" runat="server">9830762671</figcaption>
                       </div>
                    </div>
            	    <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Narendra.jpeg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption20" runat="server" style="">Narendra Nath Chatterjee(Marketing Lead)</figcaption>
                     <figcaption class="caption" id="Figcaption21" runat="server">7980426186</figcaption>
                    </div>
                    </div>
