<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TechHunt.aspx.cs" Inherits="TechHunt" %>
...
<head id="Head1" runat="server">
	...
	<meta name="description" content="Tech-Hunt: This year Convolution brings Tech Hunt, a Circuitry and Logic Based Competition where a 
...
.box:hover::before {
  left: 100%;
    ...
    <script type = "text/javascript">
        function Alert1() {
            alert('You are already registered for TechHunt');
        }

    </script>
     <script type = "text/javascript">
         function Alert2() {
             alert('You are successfully registered for TechHunt');
         }
...
<body>
    <div class="container" >
        ...
        <img src="Images/Techhunt/img1.jpg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="Images/Techhunt/img2.jpg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">3 / 3</div>
        <img src="Images/Techhunt/img3.jpg" style="width:100%; height:350px;"/>
        </div>
        </div>
        <br/>
        ...
        <div>
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h3 class="section-heading" style="margin-top:0;font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif;">TechHunt</h3>
                    ...
                    <p class="text-faded" style="color: rgba(255, 255, 255, 0.7); font-size:16px;line-height:1.2;margin-bottom:10px;">
                        This year Convolution brings Tech Hunt, a Circuitry and Logic Based Competition where a 
                participant doesn't build circuits but deconstructs them, finds out what is ailing them, and suggests modifications using prior
                knowledge of circuit theory, electronics and a good measure of logical thinking.The event promises to test both reasoning and technical
                know-how of enthusiasts.
                    </p>
...
Copyright ©<script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved.
    ...
    <script type="text/javascript">
        function button1_click() {
            window.open("/Data/techhunt.pdf", "_blank");
        }
    </script>
	<script>
	    (function () {
