<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AlgomaniacTeam.aspx.cs" Inherits="AlgomaniacTeam" %>
    ...
    <div class="container" >
		...
		<div class="content" style="background-color:#2a2b30;">
            <form id="form1" runat="server">
                <p class="section-heading" style="margin-top:auto; text-align:center; text-decoration:solid; font-size:20px; font-weight:bold; font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif; z-index:auto;"><u>Algomaniac Team</u></p>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/IP.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption1" runat="server">Indraneel Pal(Event Lead)</figcaption>
                     <figcaption class="caption" id="Figcaption3" runat="server"> 9830762671 </figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Abhik1.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption2" class="caption" runat="server">Abhik Pramanik</figcaption>
                        <figcaption class="caption" id="Figcaption4" runat="server">9851690215</figcaption>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Abhinaba.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption5" runat="server">Abhinaba Chatterjee</figcaption>
                     <figcaption class="caption" id="Figcaption6" runat="server">7364097270</figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/PPC.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption7" class="caption" runat="server">Pranabendra Prasad Chandra</figcaption>
                        <figcaption class="caption" id="Figcaption8" runat="server">8334958448</figcaption>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/GautamK.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption9" runat="server">Gautam Kumar</figcaption>
                     <figcaption class="caption" id="Figcaption10" runat="server">9470223620</figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/GautamS.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption11" class="caption" runat="server">Gautam Shankar</figcaption>
                        <figcaption class="caption" id="Figcaption12" runat="server">7634878179</figcaption>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Deepak.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption13" runat="server">Deepak Kumar Roy</figcaption>
                     <figcaption class="caption" id="Figcaption14" runat="server">8240079879</figcaption>
                   </div>                  
                </div>
