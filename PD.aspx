<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PD.aspx.cs" Inherits="SangLap" %>
...
<head id="Head1" runat="server">
	...
	<meta name="description" content="Panel Discussion:  Convolution's 6th edition shall witness an interdisciplinary talk on a plethora of vivid yet related 
                fields ranging from artificial intelligence to international relations, neuro-linguistics to engineering and many
                other topics, in an attempt to project the socio-economic reverbations of increased automation, and demystify the supposed symbiosis that machines and humans
                have been sharing for so long." />
...
.box:hover::before {
  left: 100%;
    ...
    <script type = "text/javascript">
        function Alert1() {
            alert('You are already registered for Panel Discussion');
        }

    </script>
     <script type = "text/javascript">
         function Alert2() {
             alert('You are successfully registered for Panel Discussion');
         }
...
<body>
    <div class="container" >
		...
		<nav id="ml-menu" class="menu">
			...
			<div class="menu__wrap">
                ...
                <ul data-menu="submenu-4" id="submenu-4" class="menu__level" tabindex="-1" role="menu" aria-label="Committee">
                    ...
                    <li class="menu__item" role="menuitem"><a class="menu__link" href="SangLapTeam.aspx">SangLap Team</a></li>
				</ul>
        ...
        <img src="Images/PD/image1.jpeg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="Images/PD/img4.jpeg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">3 / 3</div>
        <img src="Images/PD/image3.jpeg" style="width:100%; height:350px;"/>
        </div>
        </div>
        <br/>
        ...
        <div>
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h3 class="section-heading" style="margin-top:0;font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif;">'Welcome to The Machine' - A Panel Discussion</h3>
                    ...
                    <p class="text-faded" style="color: rgba(255, 255, 255, 0.7); font-size:16px;line-height:1.2;margin-bottom:10px;">
                       Convolution's 6th edition shall witness an interdisciplinary talk on a plethora of vivid yet related 
                fields ranging from artificial intelligence to international relations, neuro-linguistics to engineering and many
                other topics, in an attempt to project the socio-economic reverbations of increased automation, and demystify the supposed symbiosis that machines and humans
                have been sharing for so long.
                    </p>
            ...
            <form id="form1" runat="server">
                ...
                <div style="text-align:center; display:flexbox;" class="datalist">
                    <asp:DataList ID="Datalist1" CssClass="datalist" runat="server" HorizontalAlign="Center" RepeatDirection="Horizontal"  RepeatColumns="8" DataKeyField="Email"  CellPadding="0" CellSpacing="5">
                <ItemTemplate >
