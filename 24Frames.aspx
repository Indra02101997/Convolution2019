<%@ Page Language="C#" AutoEventWireup="true" CodeFile="24Frames.aspx.cs" Inherits="_24Frames" %>
...
<head id="Head1" runat="server">
	...
	<meta name="description" content="24 Frames : This Convolution, we unveil our very own photography exhibition &quot;24 Frames&quot;,
named after Kiarostami&apos;s poetic farewell, to bring to the fore all the camera-wielding enthusiasts,
the ones who could meander through the forgotten streets of a city only to lend a kaleidoscopic
eye to all its dimensions."/>
...
.box:hover::before {
  left: 100%;
    ...
    <script type = "text/javascript">
        function Alert1() {
            alert('You are already registered for 24 Frames');
        }

    </script>
     <script type = "text/javascript">
         function Alert2() {
             alert('You are successfully registered for 24 Frames');
         }
    ...
    <div class="container" >
        ...
        <img src="Images/photo/image1.jpeg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="Images/photo/image2.jpeg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">3 / 3</div>
        <img src="Images/photo/image3.jpeg" style="width:100%; height:350px;"/>
        </div>
        </div>
        <br/>
        ...
        <div>
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h3 class="section-heading" style="margin-top:0;font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif;">24 Frames</h3>
                    <hr class="light"/ style="border-color: white; border-width: 3px;max-width: 50px;"/>
                    <p class="text-faded" style="color: rgba(255, 255, 255, 0.7); font-size:16px;line-height:1.2;margin-bottom:10px;">This Convolution, we unveil our very own photography exhibition &quot;24 Frames&quot;,
named after Kiarostami&apos;s poetic farewell, to bring to the fore all the camera-wielding enthusiasts,
the ones who could meander through the forgotten streets of a city only to lend a kaleidoscopic
eye to all its dimensions.
                    </p>
            ...
            <form id="form1" runat="server">
                ...
                <ItemTemplate>
                <asp:Image ID="imagebutton1" runat="server" ImageUrl='<%#Eval("Image") %>' Width="100px" Height="120px" CssClass="img" />          
...
Copyright ©<script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved.
    ...
    <script type="text/javascript">
        function button1_click() {
            window.open("/Data/photo.pdf", "_blank");
        }
    </script>
	<script>
	    (function () {
