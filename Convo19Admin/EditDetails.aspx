<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditDetails.aspx.cs" Inherits="Convo19Admin_EditDetails" %>
   ...
   <li class='has-sub'><a href='#'><span>Profile</span></a>
    ...
    <br />
        ...
        <fieldset>
            ...
            <asp:Label ID="label1" runat="server" CssClass="label">Code :</asp:Label>
            <asp:TextBox ID="TextBox2" runat="server" CssClass="text" ReadOnly="true"></asp:TextBox>
        ...
        <fieldset>
            ...
            <asp:CheckBox ID="RadioButton1" runat="server" Text="Circuistic" CssClass="label" />
            <asp:CheckBox ID="RadioButton2" runat="server" Text="SparkHack" CssClass="label" />
            <asp:CheckBox ID="RadioButton3" runat="server" Text="Algo" CssClass="label" />
            <asp:CheckBox ID="RadioButton4" runat="server" Text="Decisia" CssClass="label" />
            <asp:CheckBox ID="RadioButton5" runat="server" Text="Papier" CssClass="label" />
            <asp:CheckBox ID="RadioButton6" runat="server" Text="Quiz" CssClass="label" />
            <asp:CheckBox ID="RadioButton7" runat="server" Text="TechHunt" CssClass="label" />
            <asp:CheckBox ID="RadioButton8" runat="server" Text="Abol Tabol" CssClass="label" />
            <asp:CheckBox ID="RadioButton9" runat="server" Text="PD" CssClass="label"/>
            <asp:CheckBox ID="RadioButton10" runat="server" Text="24 Frames" CssClass="label" />
        </fieldset>
        <br />
