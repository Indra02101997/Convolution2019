<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Inquizzitive.aspx.cs" Inherits="Inquizzitive" %>
...
<head id="Head1" runat="server">
	...
	<meta name="description" content="Inquizzitive: With it's unique blend of Business and Technology and an innovative round on all things Electrical, Inquizzitive the annual quiz of Convolution has gained considerable repute in the Quizzing Fraternity.
                        Our Quizmaster for the day would be Mr. Samanway Banerjee. He has been the QM at the prestigious Kolkata Quiz Festival multiple times and has hosted events for all major schools and colleges of the city. " />
...
.box:hover::before {
  left: 100%;
    ...
    <script type = "text/javascript">
        function Alert1() {
            alert('You are already registered for Inquizzitive');
        }

    </script>
     <script type = "text/javascript">
         function Alert2() {
             alert('You are successfully registered for Inquizzitive');
         }
...
<body>
    <div class="container" >
        ...
        <img src="Images/Quiz/image1.jpeg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="Images/Quiz/img2.jpg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">3 / 3</div>
        <img src="Images/Quiz/image2.jpeg" style="width:100%; height:350px;"/>
        </div>
        </div>
        <br/>
        ...
        <div>
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h3 class="section-heading" style="margin-top:0;font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif;">Inquizzitive</h3>
                    ...
                    <p class="text-faded" style="color: rgba(255, 255, 255, 0.7); font-size:16px;line-height:1.2;margin-bottom:10px;"> 
                         With it's unique blend of Business and Technology and an innovative round on all things Electrical, Inquizzitive the annual quiz of Convolution has gained considerable repute in the Quizzing Fraternity.
                        Our Quizmaster for the day would be Mr. Samanway Banerjee. He has been the QM at the prestigious Kolkata Quiz Festival multiple times and has hosted events for all major schools and colleges of the city. 
                    </p>
...
Copyright ©<script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved.
    ...
    <script type="text/javascript">
        function button1_click() {
            window.open("/Data/quiz.pdf", "_blank");
        }
    </script>
	<script>
	    (function () {
