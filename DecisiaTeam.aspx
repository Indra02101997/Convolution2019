<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DecisiaTeam.aspx.cs" Inherits="DecisiaTeam" %>
    ...
    <div class="container" >
		...
		<nav id="ml-menu" class="menu">
			...
			<div class="menu__wrap">
				...
				<!-- Submenu 3 -->
				<ul data-menu="submenu-3" id="submenu-3" class="menu__level" tabindex="-1" role="menu" aria-label="Sponsors">
					<li class="menu__item" role="menuitem"><a class="menu__link" href="Sponsors.aspx">Sponsors</a></li>
		...
		<div class="content" style="background-color:#2a2b30;">
            <form id="form1" runat="server">
                <p class="section-heading" style="margin-top:auto; text-align:center; text-decoration:solid; font-size:20px; font-weight:bold; font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif; z-index:auto;"><u>Decisia Team</u></p>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Abhinaba.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption1" runat="server">Abhinaba Chatterjee(Event Lead)</figcaption>
                     <figcaption class="caption" id="Figcaption3" runat="server">7364097270</figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Bodhi.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption2" class="caption" runat="server">Bodhisatya Pal</figcaption>
                        <figcaption class="caption" id="Figcaption4" runat="server">9073440811</figcaption>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Ishan.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption5" runat="server">Ishan Palit</figcaption>
                     <figcaption class="caption" id="Figcaption6" runat="server">7596996453</figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Moja.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption7" class="caption" runat="server">Mojaffar Islam</figcaption>
                        <figcaption class="caption" id="Figcaption8" runat="server">9153539095</figcaption>
                     </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Madhu.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption9" runat="server">Madhu Basumata</figcaption>
                     <figcaption class="caption" id="Figcaption10" runat="server">7860164078</figcaption>
                   </div>
                    <div class="column" style="">
                     <img class="resize1" src="Team/Sweety.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption11" class="caption" runat="server">Sweety Kumari Vishwakarma </figcaption>
                        <figcaption class="caption" id="Figcaption12" runat="server">8777637398</figcaption>
                     </div>                    
                </div>
