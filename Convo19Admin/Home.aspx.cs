...
public partial class Convo19Admin_Home : System.Web.UI.Page
{
            ...
            using (SqlCommand cmd = new SqlCommand(s))
            {
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    ...
                    using (DataTable dt = new DataTable())
                    {
                        ...
                        Response.AddHeader("content-disposition", "attachment;filename=AllEmail.txt");
                        Response.Charset = "";
            ...
            using (SqlCommand cmd = new SqlCommand(s))
            {
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    ...
                    using (DataTable dt = new DataTable())
                    {
                        ...
                        Response.Clear();
                        Response.Buffer = true;
                        Response.AddHeader("content-disposition", "attachment;filename=AllData.csv");
                        Response.Charset = "";
