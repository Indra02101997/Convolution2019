<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Algomaniac.aspx.cs" Inherits="Algomaniac" %>
...
<head id="Head1" runat="server">
	...
	<title>Algomaniac</title>
	<meta name="description" content="Algomaniac:  Sharpen your knowledge on Data Structures and Algorithms,because Algomaniac is back again this year to take you on an Algorithmic Extravaganza where only the best coder will be victorious. It is basically a coding contest that is meant to check your problem solving skills and analytical abilities." />
...
.box:hover::before {
  left: 100%;
    ...
    <script type = "text/javascript">
        function Alert1() {
            alert('You are already registered for Algomaniac');
        }

    </script>
     <script type = "text/javascript">
         function Alert2() {
             alert('You are successfully registered for Algomaniac');
         }
...
<body>
    <div class="container" >
        ...
        <img src="Images/Algo/img1.jpg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="Images/Algo/img2.jpg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">3 / 3</div>
        <img src="Images/Algo/img3.jpg" style="width:100%; height:350px;"/>
        </div>
        </div>
        <br/>
        ...
        <div>
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h3 class="section-heading" style="margin-top:0;font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif;">Algomaniac</h3>
                    ...
                    <p class="text-faded" style="color: rgba(255, 255, 255, 0.7); font-size:16px;line-height:1.2;margin-bottom:10px;">
                        Sharpen your knowledge on Data Structures and Algorithms,because Algomaniac is back again this year to take 
                        you on an Algorithmic Extravaganza where only the best coder will be victorious. It is basically a coding contest
                        that is meant to check your problem solving skills and analytical abilities.
                    </p>
                </div>
            </div>
        </div>
...
Copyright ©<script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved.
    ...
    <script type="text/javascript">
        function button1_click() {
            window.open("/Data/algomaniac.pdf", "_blank");
        }
    </script>
	<script>
	    (function () {
