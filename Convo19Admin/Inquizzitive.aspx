<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Inquizzitive.aspx.cs" Inherits="Convo19Admin_Inquizzitive" %>
...
<head>
   ...
   <title>Inquizzitive Admin</title>
    <style type="text/css">
        .h1 {
            color: #ff4a56;
            font-weight: 100;
...
<ul>
   ...
   <li class='has-sub'><a href='#'><span>Profile</span></a>
    ...
    <div id="div1" class="datalist" style="position:relative;">
        ...
        <label class="h1">Total Registered in Inquizzitive :</label>
