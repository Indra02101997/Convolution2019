<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sparkhack.aspx.cs" Inherits="Sparkhack" %>
...
<head id="Head1" runat="server">
	...
	<title>SparkHack</title>
	<meta name="description" content="SparkHack:  SparkHack is a hackathon focussing on technological entrepreneurship ideas with some positive social impacts where teams embark on a 
                        3-day long creative joyride where they build a prototype of their product and prepare a presentation for their venture along corporate lines." />
...
.box:hover::before {
  left: 100%;
    ...
    <script type = "text/javascript">
        function Alert1() {
            alert('You are already registered for SparkHack');
        }

    </script>
     <script type = "text/javascript">
         function Alert2() {
             alert('You are successfully registered for SparkHack');
         }
...
<body>
    <div class="container" >
        ...
        <img src="Images/Sparkhack/img1.jpg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="Images/Sparkhack/img2.jpg" style="width:100%;height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">3 / 3</div>
        <img src="Images/Sparkhack/img3.jpg" style="width:100%;height:350px;"/>
        </div>
        </div>
        <br/>
        ...
        <div>
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h3 class="section-heading" style="margin-top:0;font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif;">SparkHack</h3>
                    ...
                    <p class="text-faded" style="color: rgba(255, 255, 255, 0.7); font-size:16px;line-height:1.2;margin-bottom:10px;">
                        SparkHack is a hackathon focussing on technological entrepreneurship ideas with some positive social impacts where teams embark on a 
                        3-day long creative joyride where they build a prototype of their product and prepare a presentation for their venture along corporate lines.
                    </p>
                </div>
            </div>
...
Copyright ©<script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved.
    ...
    <script type="text/javascript">
        function button1_click() {
            window.open("/Data/SparkHack.pdf", "_blank");
        }
    </script>
	<script>
	    (function () {
