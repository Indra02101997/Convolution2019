<%@ Page Language="C#" AutoEventWireup="true" CodeFile="24FramesTeam.aspx.cs" Inherits="_24FramesTeam" %>
    ...
    <div class="container" >
		...
		<div class="content" style="background-color:#2a2b30;">
            <form id="form1" runat="server">
                <p class="section-heading" style="margin-top:auto; text-align:center; text-decoration:solid; font-size:20px; font-weight:bold; font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif; z-index:auto;"><u>24Frames Team</u></p>
                <br />
                <br />
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Suvadeep1.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption1" runat="server"> Suvadeep Maiti(Event Lead)</figcaption>
                     <figcaption class="caption" id="Figcaption2" runat="server"> 8240586094</figcaption>
                   </div>                    
                </div>
