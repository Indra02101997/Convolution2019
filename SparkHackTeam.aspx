<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SparkHackTeam.aspx.cs" Inherits="SparkHackTeam" %>
    ...
    <div class="container" >
		...
		<div class="content" style="background-color:#2a2b30;">
            <form id="form1" runat="server">
                <p class="section-heading" style="margin-top:auto; text-align:center; text-decoration:solid; font-size:20px; font-weight:bold; font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif; z-index:auto;"><u>SparkHack Team</u></p>
                <div class="row">
                    <div class="column" style="">
                     <img class="resize" src="Team/RounakA.jpg" style=" border-radius:50%" />
                        <figcaption id="Figcaption2" class="caption" runat="server">Rounak Adhikary(Event Lead)</figcaption>
                        <figcaption class="caption" id="Figcaption4" runat="server">8584032846</figcaption>
                     </div>
                    <div class="column">
                    <img class="resize1" src="Team/Bhaskar1.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption1" runat="server">Bhaskar Dutta</figcaption>
                     <figcaption class="caption" id="Figcaption3" runat="server">7044629680</figcaption>
                   </div>                    
                </div>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Shubham1.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption5" runat="server">Shubham Saha</figcaption>
                     <figcaption class="caption" id="Figcaption6" runat="server">8101135959</figcaption>
                   </div>
                    <div class="column">
                    <img class="resize1" src="Team/Kash.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption7" runat="server">Kashmira Sardar</figcaption>
                     <figcaption class="caption" id="Figcaption8" runat="server">9875566257</figcaption>
                   </div>                   
                </div>
