<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Papier.aspx.cs" Inherits="Papier" %>
...
<head id="Head1" runat="server">
	...
	<title>Papier</title>
	<meta name="description" content="Papier: Wanna get your reasearch work published and put it across to some of the best academicians in the town?
                        Then grab the chance with Papier presented by Convolution, 2019." />
...
.box:hover::before {
  left: 100%;
    ...
    <script type = "text/javascript">
        function Alert1() {
            alert('You are already registered for Papier');
        }

    </script>
     <script type = "text/javascript">
         function Alert2() {
             alert('You are successfully registered for Papier');
         }
...
<body>
    <div class="container" >
        ...
        <img src="Images/Papier/img1.jpg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="Images/Papier/img2.jpg" style="width:100%; height:350px;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">3 / 3</div>
        <img src="Images/Papier/img3.jpg" style="width:100%; height:350px;"/>
        </div>
        </div>
        <br/>
        ...
        <div>
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h3 class="section-heading" style="margin-top:0;font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif;">Papier</h3>
                    <hr class="light"/ style="border-color: white; border-width: 3px;max-width: 50px;"/>
                    <p class="text-faded" style="color: rgba(255, 255, 255, 0.7); font-size:16px;line-height:1.2;margin-bottom:10px;">Dreamed about a paper presentation event offering cash prizes and a chance to get your work published??
Then grab the pefect opportunity through PAPIER, presented by Convolution 2019. 
Total prizes worth Rs.12500/- to be won!!
Last but not the least, the best papers of PAPIER will be published in the proceedings of IET Students' Technology Congress, in September, 2019.
                    </p>
            ...
            <form id="form1" runat="server">
                ...
                <ItemTemplate>
                <asp:Image ID="imagebutton1" runat="server" ImageUrl='<%#Eval("Image") %>' Width="120px" Height="120px" CssClass="img" />          
...
Copyright ©<script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved.
    ...
    <script type="text/javascript">
        function button1_click() {
            window.open("/Data/papier.pdf", "_blank");
        }
    </script>
	<script>
	    (function () {
