<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InquizzitiveTeam.aspx.cs" Inherits="InquizzitiveTeam" %>
    ...
    <div class="container" >
		...
		<div class="content" style="background-color:#2a2b30;">
            <form id="form1" runat="server">
                <p class="section-heading" style="margin-top:auto; text-align:center; text-decoration:solid; font-size:20px; font-weight:bold; font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif; z-index:auto;"><u>Inquizzitive Team</u></p>
                <div class="row">
                    <div class="column">
                    <img class="resize" src="Team/Ishan.jpg" style=" border-radius:50%" />
                     <figcaption class="caption" id="Figcaption1" runat="server"> Ishan Palit(Event Lead)</figcaption>
                     <figcaption class="caption" id="Figcaption2" runat="server"> 7596996453</figcaption>
                   </div>                    
                </div>
