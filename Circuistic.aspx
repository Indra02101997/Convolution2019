<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Circuistic.aspx.cs" Inherits="Circuistic" %>
...
<head id="Head1" runat="server">
	...
	<title>Circuistic</title>
	<meta name="description" content="Circuistic:  Electronic Circuits power the world today, so do Signal Processing operations. CIRCUISTIC 6.0 provides you with the stage to showcase your circuit designing and problem solving skills. Innovation and research are what we are looking for in this circuit building and computational problem solving challenge." />
...
.box:hover::before {
  left: 100%;
    ...
    <script type = "text/javascript">
        function Alert1() {
            alert('You are already registered for Circuistic');
        }

    </script>
     <script type = "text/javascript">
         function Alert2() {
             alert('You are successfully registered for Circuistic');
         }
...
<body>
    <div class="container" >
        ...
        <img  src="Images/Circuistic/img1.jpg" style="height:350px; width:100%;"/>
        </div>

        <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="Images/Circuistic/img2.jpg" style="height:350px; width:100%;" />
        </div>

        <div class="mySlides fade">
        <div class="numbertext">3 / 3</div>
        <img src="Images/Circuistic/img3.jpg" style="height:350px; width:100%;" />
        </div>
        </div>
        <br/>
        ...
        <div>
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading" style=" margin-top:0; font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif;">Circuistic</h2>
                    <hr class="light" style="border-color: white; border-width: 3px;max-width: 50px;"/>
                    <p class="text-faded" style="color: rgba(255, 255, 255, 0.7); font-size:15px;line-height:1.2;margin-bottom:10px;">
                        Electronic Circuits power the world today, so do Signal Processing operations. CIRCUISTIC 6.0 provides you with the stage to showcase
                        your circuit designing and problem solving skills. Innovation and research are what we are looking for in this circuit building
                        and computational problem solving challenge.
                    </p>
                </div>
            </div>
            ...
            <form id="form1" runat="server">
                ...
                <div style="position:relative; top:auto; text-align:center ;">
...
Copyright ©<script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved.
    ...
    <script type="text/javascript">
        function button1_click() {
            window.open("/Data/circuistic.pdf", "_blank");
        }
    </script>
	<script>
	    (function () {
